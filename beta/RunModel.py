...
def model(Sample=-1, Replica=-1):
    ...
    callingModel = ['./PulmonaryMicroMets', 'PatientVariation/output_S'+str("%06d"%Sample)+'_R'+str("%02d"%Replica)+'/config.xml']
    # callingModel = ['./PulmonaryMicroMets', '/N/slate/hlimadar/PulmonaryMicroMets_v3/output_S'+str("%06d"%Sample)+'_R'+str("%02d"%Replica)+'/config.xml']
    # callingModel = ['./PulmonaryMicroMets', 'output/output_S'+str("%06d"%Sample)+'_R'+str("%02d"%Replica)+'/config.xml']
